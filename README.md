# Sushilicious - My First Web Development Project
...
## What I Learned
- New (to me) HTML elements such as unordered lists, breaks & articles
- CSS imports
- How to use BEM (Block Element Modifier) for cleaner class naming
- Managing CSS variables to easily swap color schemes across the whole site
- Creating Animations & Responsive Design
- The importance of regular Git commits after finishing each section

## Credits
Developed while following this tutorial by JavaScript Mastery: https://youtu.be/QRrPE9aj3wI?si=sVdwGEafIVGCP6_5
